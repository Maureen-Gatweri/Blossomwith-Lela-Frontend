    ...
    <>
      ...
      <div className="search-wrap">
        <div style={{ marginBottom: "2rem" }}>
          <p style={{ fontFamily: "Jost, sans-serif", fontSize: "0.6rem", letterSpacing: "0.25em", textTransform: "uppercase", color: "#c97b84", marginBottom: "0.5rem" }}>Search Results</p>
        ...
        {loading && (
          <p style={{ fontFamily: "Jost, sans-serif", fontSize: "0.8rem", color: "rgba(61,43,43,0.4)", padding: "3rem 0", textAlign: "center" }}>
            Searching...
          </p>
        )}
              ...
              <div key={p._id} style={{ display: "flex", flexDirection: "column" }}>
                <Link href={"/product/" + p._id} style={{ textDecoration: "none" }}>
                  <div style={{ width: "100%", aspectRatio: "3/4", overflow: "hidden", background: "#f7f5f2", marginBottom: "0.75rem" }}>
                    <img src={p.images?.[0] || "/images/sheabutter.jpg"} alt={p.name}
                      style={{ width: "100%", height: "100%", objectFit: "cover", display: "block" }} />
                  </div>
                </Link>
                <p style={{ fontFamily: "Jost, sans-serif", fontSize: "0.6rem", letterSpacing: "0.13em", textTransform: "uppercase", textAlign: "center", color: "#3d2b2b", fontWeight: 500, marginBottom: "0.22rem" }}>{p.name}</p>
                <p style={{ fontFamily: "Jost, sans-serif", fontSize: "0.68rem", textAlign: "center", color: "rgba(61,43,43,0.42)", fontWeight: 300, marginBottom: "0.75rem" }}>KSh {p.price.toLocaleString()}</p>
                <button onClick={() => { addItem(p); toast.success(p.name + " added!"); }}
                  style={{ width: "100%", border: "1px solid rgba(61,43,43,0.2)", background: "transparent", color: "#3d2b2b", fontFamily: "Jost, sans-serif", fontSize: "0.52rem", letterSpacing: "0.16em", textTransform: "uppercase", padding: "0.58rem 0.4rem", cursor: "pointer", transition: "all 0.22s" }}>
                  Add to Cart
                </button>
              </div>
            ))}
